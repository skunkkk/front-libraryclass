    ...
    <div className='config-container'>
      ...
      <div className="faq-div">
       <h2>Como funciona o mural?</h2>
        <p className='txtfaq'>O mural é um meio de comunicação entre o aluno e a coordenação.</p>
        <p className='txtfaq'>La você pode fazer perguntas que serão respondidas no feed.</p>
      </div>
      <div className="faq-div">
