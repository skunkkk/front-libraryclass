  ...
  <p>Voltar</p>
      ...
      <div className='alinharInput'>
        <div className='classInput'>
                <label>ID: </label>
                <input type="text" className='input-autor' placeholder='Insira o ID'/>
            </div>
            <div className='classInput' onChange={(e) => setAutor_nome(e.target.value)}>
                <label>Nome do autor: </label>
                <input type="text" className='input-autor'  placeholder='Insira o Autor'/>
           </div>
           <div className='classInput'onChange={(e) => setAutor_nacionalidade(e.target.value)}>
                <label>Nacionalidade do autor: </label>
                <input type="text" className='input-autor'  placeholder='Insira a Nacionalidade Autor'/>
           </div>
           </div>
            <button className='button-autor' onClick={()=>adicionarAutor()}>Criar autor</button>
    </div>
  )
}
